...
import BottomWearCollection from './bottomWearCollection';
  ...
  return (
    <Container fluid className="mt-5" style={{ paddingTop: '50px' }}>
      <Row>
        ...
        <Col md={10}>
          <img
            src="https://media.powerlook.in/catalog/category/denim.jpg?aio=w-1920"
          ...
          <div className="d-flex justify-content-between align-items-center mt-2 mb-3">
            <div>
              <p className="mb-1">
                <span className="text-dark" style={{ fontWeight: "500" }}>BOTTOM WEAR</span>
              </p>
          ...
          <BottomWearCollection selectedColors={selectedColors} selectedPriceRanges={selectedPriceRanges} sortOrder={sortOrder} />
        </Col>
      </Row>
    </Container>
