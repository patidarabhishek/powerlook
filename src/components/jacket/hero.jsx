...
import JacketCollection from './jacketCollection';
    ...
    return (
        <Container fluid className="mt-5" style={{ paddingTop: '50px' }}>
            <Row>
                ...
                <Col md={10}>
                    <img
                        src="https://media.powerlook.in/catalog/category/checked_print-1.jpg?aio=w-1920"
                        alt="Shirt Banner"
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-2 mb-3">
                        <div>
                            <p className="mb-1">
                                <span className="text-dark" style={{ fontWeight: "500" }}>JACKET</span>
                            </p>
                    ...
                    <JacketCollection selectedColors={selectedColors} selectedPriceRanges={selectedPriceRanges} sortOrder={sortOrder} />
                </Col>
            </Row>
        </Container>
