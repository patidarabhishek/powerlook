...
const Hero = () => {
  ...
  return (
    <Container fluid className="" style={{ paddingTop: '120px' }}>
      <Row>
        {/* Sidebar Filters */}
        <Col
          md={2}
        ...
        >          <div className="d-flex justify-content-between align-items-center mb-2">
          ...
          <Form>
            ...
            {["₹0.00 - ₹499.99", "₹500.00 - ₹999.99", "₹1,000.00 - ₹1,499.99", "₹1,500.00 - ₹1,999.99"]
              .map((range, idx) => (
        ...
        <Col md={10}>
          <img
            src="https://media.powerlook.in/catalog/category/summer_category-2.jpg?aio=w-1920"
            alt="Summer Banner"
          ...
          <div className="d-flex justify-content-between align-items-center mt-2 mb-3">
            <div>
              <p className="mb-1">
                <span className="text-dark" style={{ fontWeight: "500" }}> SUMMER_2025</span>
              </p>
          ...
          <SummerCollection selectedColors={selectedColors} selectedPriceRanges={selectedPriceRanges} sortOrder={sortOrder} />
        </Col>
      </Row>
    </Container>
