...
const NewArrivalCollection = ({ selectedColors = [], selectedPriceRanges = [], sortOrder = '' }) => {
  ...
  useEffect(() => {
    ...
    if (newArrivalProducts.length > 0 && sortedProducts.length === 0) {
      toast.dismiss();
      toast.warning('No products found matching your filters.');
    }
  }, [sortedProducts, newArrivalProducts]);
